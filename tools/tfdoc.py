...
get_tftest_directive = lambda x: None
...
REPO_URL = 'https://github.com/hilmanmustofaa/gcp-infra-archtf/blob/main'
...
VAR_TEMPLATE = ('default', 'description', 'type', 'nullable', 'sensitive', 'nullable')
